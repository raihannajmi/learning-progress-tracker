...
async function runMigration() {
  ...
  await db.execute(sql`
    ...
    ALTER TABLE learning_sprints ADD COLUMN IF NOT EXISTS needs_feedback boolean DEFAULT false NOT NULL;
    ...
    CREATE INDEX IF NOT EXISTS learning_sprints_needs_feedback_idx ON learning_sprints (needs_feedback);
  `);
